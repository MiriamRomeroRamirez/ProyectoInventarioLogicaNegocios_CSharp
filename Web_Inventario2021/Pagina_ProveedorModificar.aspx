<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Pagina_ProveedorModificar.aspx.cs" Inherits="Web_Inventario2021.Pagina_ProveedorModificar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="Contenido">
        ...
        <asp:Label ID="lblTituloPrincipal" runat="server" Text="Modificar detalles de proveedores"></asp:Label>
        <br />
        <br />
        <asp:Label ID="lblListaProveedores" runat="server" Text="Lista proveedores: "></asp:Label>
        <asp:DropDownList ID="ddlListaProveedores" runat="server" CssClass="EstiloBoton">
        </asp:DropDownList>
        <asp:Button ID="btnCargarProv" runat="server" Text="Cargar" CssClass="EstiloBoton" OnClick="btnCargarProv_Click" />
        <asp:Button ID="btnMostrar" runat="server" Text="Mostrar" CssClass="EstiloBoton" OnClick="btnMostrar_Click" />
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Button ID="btnModificar" runat="server" Text="Guardar cambios" CssClass="EstiloBoton" OnClick="btnModificar_Click" />
        <asp:Button ID="btnEliminar" runat="server" Text="Eliminar registro" CssClass="EstiloBoton" OnClick="btnEliminar_Click" />
        <br />
